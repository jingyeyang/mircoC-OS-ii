...
#endif /* M11102155_PA2_PART_1_EDF 1*/
...
void  OSTimeTick (void)
{
    ...
    if (OSRunning == OS_TRUE) {
        ...
        {
#if defined (M11102155_HW1) | defined (M11102155_PA1_PART_2_RM) | defined (M11102155_PA2_PART_1_EDF)
            // Close the output file.
            fclose(Output_fp);
#endif /* M11102155_HW1 | M11102155_PA1_PART_2_RM | M11102155_PA2_PART_1_EDF*/
            OSRunning = OS_FALSE;
            exit(0);
        }
        /* Setting the end time for the OS */
